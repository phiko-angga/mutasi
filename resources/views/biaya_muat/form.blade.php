...
<form id="form-user" method="post" enctype="multipart/form-data" action="{{$action == 'store' ? route('biaya-muat.store') : route('biaya-muat.update',$biaya->id)}}">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input required type="text" maxLength="3" class="form-control numeric" id="biaya_laut" name="biaya_laut" value="{{old('biaya_laut',isset($biaya->biaya_laut) ? number_format($biaya->biaya_laut) : '0')}}" />
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-8">
                            ...
                            <a href="{{url('biaya-muat')}}" class="btn btn-secondary">back</a>
