@extends('layout._template',['title' => 'Biaya Muat Barang'])
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 grid-margin">
                        <div class="d-flex justify-content-between align-items-end flex-wrap">
                            <div class=" me-3"><a href="{{route('biaya-muat.create')}}" class="btn btn-outline-primary btn-fw btn-sm">Tambah data</a></div>
                            <div class=" me-3">
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" style="">
                                        <a class="dropdown-item print_pdf" data-url="{{url('biaya_muat_print_pdf')}}" href="javascript:void(0);">PDF</a>
                                        <a class="dropdown-item print_excel" data-url="{{url('biaya_muat_print_excel')}}" href="javascript:void(0);">EXCEL</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="table-responsive row-table">
                    <table class="table">
                        ...
                        @include('biaya_muat.list_pagination')
                    </table>
                </div>
            </div><!-- /.box-body -->
        </div><!-- /.box -->
...
<script>
    ...
    $('.delete_btn').click(function(e){
        ...
        modalConfirm.find('form').attr('action','{{url('')}}/biaya-muat/'+$(this).data('id'));
