...
<form id="form-user" method="post" enctype="multipart/form-data" action="{{$action == 'store' ? route('sbum.store') : route('sbum.update',$sbum->id)}}">
    
    @csrf   
    @if($action == 'update')
    <input name="_method" type="hidden" value="PUT">
    @endif
    <input type="hidden" name="id" value="{{isset($sbum) ? $sbum->id : ''}}">
                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-8">
                            ...
                            <a href="{{url('sbum')}}" class="btn btn-secondary">back</a>
