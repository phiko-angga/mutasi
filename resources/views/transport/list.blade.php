@extends('layout._template',['title' => 'Jenis - Jenis Transportasi'])
                ...
                <div class="row">
                    <div class="col-md-12 grid-margin">
                        <div class="d-flex justify-content-between align-items-end flex-wrap">
                            <div class=" me-3"><a href="{{route('transport.create')}}" class="btn btn-outline-primary btn-fw btn-sm">Tambah data</a></div>
                            <div class=" me-3">
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" style="">
                                        <a class="dropdown-item print_pdf" data-url="{{url('transport_print_pdf')}}" href="javascript:void(0);">PDF</a>
                                        <a class="dropdown-item print_excel" data-url="{{url('transport_print_excel')}}" href="javascript:void(0);">EXCEL</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <table class="table">
                        <thead class="header">
                            <tr>
                                ...
                                <th style="width:20%">Jenis Transport</th>
                        ...
                        @include('transport.list_pagination')
                    </table>
                </div>
            </div><!-- /.box-body -->
        </div><!-- /.box -->
...
<script>
    ...
    $('.delete_btn').click(function(e){
        ...
        modalConfirm.find('form').attr('action','{{url('')}}/transport/'+$(this).data('id'));
