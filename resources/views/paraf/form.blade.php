            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input required type="text" class="form-control" id="nama" name="nama" value="{{old('nama',isset($paraf) ? $paraf->nama : '')}}" />
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label" for="kode">NIP tertulis</label>
                        <div class="col-sm-8">
                            <input required type="text" class="form-control" id="nip" name="nip" value="{{old('nip',isset($paraf) ? $paraf->nip : '')}}" />
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label" for="kode">Kepangkatan</label>
                        <div class="col-sm-8">
                            <input required type="text" class="form-control" id="pangkat" name="pangkat" value="{{old('pangkat',isset($paraf) ? $paraf->pangkat : '')}}" />
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label" for="kode">Nama jabatan</label>
                        <div class="col-sm-8">
                            <input required type="text" class="form-control" id="jabatan" name="jabatan" value="{{old('jabatan',isset($paraf) ? $paraf->jabatan : '')}}" />
                        </div>
                    </div>
