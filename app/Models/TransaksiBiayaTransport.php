...
class TransaksiBiayaTransport extends Model
{
    use HasFactory;
    
    protected $table = "tb_transaksi_biaya_transport";
    protected $fillable = [
        'transaksi_biaya_id','manual','pembantu','transport_id','kota_asal_id','kota_tujuan_id','orang','biaya_perorang','rinci_perkiraan','jumlah_biaya','metode'
    ];
